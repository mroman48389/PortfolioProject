...
function initExperienceTagsAndPopups() {
  ...
  const skills = [
    ...
    createSkill(frontEndSkillClass, beginnerProgressClass, 'Redux', frontEndSkillText, beginnerSkillLevelText, '1+ years'),
    createSkill(frontEndSkillClass, beginnerProgressClass, 'React Router', frontEndSkillText, beginnerSkillLevelText, '1+ years'),
    createSkill(frontEndSkillClass, beginnerProgressClass, 'React Query', frontEndSkillText, beginnerSkillLevelText, '1+ years'),
    createSkill(frontEndSkillClass, beginnerProgressClass, 'SWR', frontEndSkillText, beginnerSkillLevelText, '1+ years'),
    createSkill(frontEndSkillClass, beginnerProgressClass, 'Lazy loading', frontEndSkillText, beginnerSkillLevelText, '1+ years'),
    createSkill(frontEndSkillClass, beginnerProgressClass, 'Caching', frontEndSkillText, beginnerSkillLevelText, '1+ years'),
    ...
    createSkill(frontEndSkillClass, beginnerProgressClass, 'Lighthouse', frontEndSkillText, beginnerSkillLevelText, '1+ years'), 
    ...
    createSkill(backEndSkillClass, beginnerProgressClass, 'Supabase', backEndSkillText, beginnerSkillLevelText, '1+ years'),
    ...
    createSkill(backEndSkillClass, beginnerProgressClass, 'Sentry', backEndSkillText, beginnerSkillLevelText, '1+ years'),
    createSkill(backEndSkillClass, beginnerProgressClass, 'Caching', backEndSkillText, beginnerSkillLevelText, '1+ years'),
    createSkill(backEndSkillClass, beginnerProgressClass, 'Rate limiting', backEndSkillText, beginnerSkillLevelText, '1+ years'),
    ...
    createSkill(buildDeploymentSkillClass, beginnerProgressClass, 'Fly.io', buildDeploymentSkillText, beginnerSkillLevelText, '1+ years'),
